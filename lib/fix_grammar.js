...
async function fixGrammar() {
	...
	if (await askIfWeShouldReplaceIt()) {
		replaceTheSubjectText(lineText, textToCheck, parsedResponse.corrected);
	}
}
...
async function replaceTheSubjectText(lineText, textToCheck, recommendedText) {
	...
	const newText = lineText.replace(textToCheck, recommendedText);
